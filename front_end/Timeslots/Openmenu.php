    ...
    <body>
        <div id="box">
            <div id="mySidenav" class="sidenav">
                ...
                <a class="text" href="../Device/DeviceAllocation.php">Device Allocation</a>
                ...
                <a class="text" href="Recurring.php">Recurring TimeSlots</a>
                <a class="text" href="NonRecurring.php">NonRecurring TimeSlots</a>
