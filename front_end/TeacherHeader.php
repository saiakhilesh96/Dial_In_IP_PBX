                    ...
                    <div class="passpopup">
                        ...
                        <div class="form-control">
                            <form method="post" name="changepassform" action="PassChange.php">
                                ...
                                <!--<span style="position: absolute;margin-left: -80%;margin-top: 5%;width: 40%;color: red;"><?php //echo $msg; ?></span>-->
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="cd-popup" role="alert">
                            <div class="cd-popup-container">
                                ...
                                <ul class="cd-buttons">
                                    ...
                                    <li><a href="Teacher.php">No</a></li>
                                </ul>
                                <a href="Teacher.php" class="cd-popup-close img-replace">X</a>
                            </div>
                        </div>
                    </nav>
                </div>
